						...
						while($row_usuario = mysqli_fetch_array($resultado_usuario)){
						   ...
						   <tr>
							...
							<td>
								...
								<a href="?i=cadastroMovimentacoes&id=<?php echo $row_usuario['id']; ?>&valoratual=<?php echo $row_usuario['saldo_atual']; ?>" class="btn btn-info btn-sm " role="button" >
								<i class="far fa-address-card"></i>&nbsp; Movimentacão </a>
